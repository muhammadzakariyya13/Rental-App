            ...
            <div class="flex">
                ...
                <div class="hidden space-x-3 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    @if(Auth::user()->hasRole('pemilik'))
                        ...
                        <x-nav-link :href="route('pemilik.kontrak.index')" :active="request()->routeIs('pemilik.kontrak*')">
                            {{ __('Kelola Kontrak') }}
                        </x-nav-link>
                    ...
                    @if(Auth::user()->hasRole('penyewa'))
                        ...
                        <x-nav-link :href="route('penyewa.pemesanan.index')" :active="request()->routeIs('penyewa.pemesanan*')">
                            {{ __('Pemesanan Saya') }}
                        </x-nav-link>
                        <x-nav-link :href="route('penyewa.reviews')" :active="request()->routeIs('penyewa.reviews*')">
                            {{ __('Review') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4 flex items-center gap-3">
                ...
                @else
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-lg font-bold">
                        {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                    </div>
                @endif
