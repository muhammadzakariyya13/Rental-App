        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('pemilik.properti.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="tipe" name="tipe" type="text" class="mt-1 block w-full" 
                                :value="old('tipe')" required placeholder="Contoh: Rumah, Apartemen, Kost, dll" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="5" required>{{ old('deskripsi') }}</textarea>
                        </div>
